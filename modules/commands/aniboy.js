...
"https://i.imgur.com/DKUxCGa.jpg",
  ...
  var callback = () => api.sendMessage({ body: `Anime profile for you`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"), event.messageID);
